...
* "Dynaamisten kysymysten" lisäys
  * Sellaisia kysymyksiä, joissa olisi muuttujia (esimerkiksi matematiikan laskutehtävässä voisi arpoa tehtävän lausekkeen arvot) ja laskea kullekkin tehtävälle oikeat vastaukseterikseen
